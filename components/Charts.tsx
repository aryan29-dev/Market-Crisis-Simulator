...
export default function Charts({ result }: { result: SimulationResult | null }) {
    if (!result) {
        return <div className="card p-6 text-sm text-neutral-600">Run a stress test to see charts.</div>;
    }
        ...
        <div className="space-y-4">
            <div className="card p-5">
                ...
                <div className="mt-4 h-95">
                    <ResponsiveContainer>
                        <LineChart data={equity} margin={{ top: 16, right: 18, left: 88, bottom: 28 }}>
            ...
            <div className="card p-5">
                ...
                <div className="mt-4 h-90">
                    <ResponsiveContainer>
                        <LineChart
                            data={drawdown}
                            margin={{ top: 40, right: 18, left: 120, bottom: 28 }}>
                            <CartesianGrid strokeDasharray="3 3" />
                            <XAxis
                                dataKey="date"
                                tickFormatter={fmtMonthYear}
